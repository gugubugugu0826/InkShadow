...
const TASK_REQUIRED_CAPABILITIES: Readonly<Record<NovelAiTask, readonly ModelHubCapability[]>> =
  Object.freeze({
    ...
    outline_planning: ["text_generation", "structured_output"],
    scene_breakdown: ["text_generation", "structured_output"],
...
const TASK_PREFERRED_CAPABILITIES: Readonly<Record<NovelAiTask, readonly ModelHubCapability[]>> =
  Object.freeze({
    ...
    polish: ["long_context"],
    outline_planning: ["reasoning"],
    scene_breakdown: ["reasoning"],
