  ...
  return (
    ...
    >
      <InlineAlert
        ...
        description="生成结果始终先保存为隔离 Candidate；只有你明确选择使用后，正文和不可变版本才会改变。随后可在本机整理有明确原文依据的普通设定。"
      />
      <ul>
        <li>这项授权不允许自动接受 Candidate；每次正文变更仍由你明确确认。</li>
        <li>整理过程不会调用模型，不会增加 Provider 次数或费用。</li>
        <li>每条设定都保留对应不可变版本和原文位置，可重新构建。</li>
