...
6. 不复用或强制移动已经发布的版本标签。`v0.2.0`、`v0.2.1` 和 `v0.2.2` 保持不可变；
   后续修复使用新的补丁版本。
...
`v0.2.2`。`0.2.0` / `v0.2.0`、`0.2.1` / `v0.2.1` 与 `0.2.2` / `v0.2.2` 均已公开，
