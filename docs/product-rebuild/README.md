...
> 基线日期：2026-08-01  
> 最近复核：2026-08-22（DESIGN v0.3.1b、已发布 v0.2.6 与未发布 v0.2.7 直接模式工作树）  
> 文档状态：`AUTHORITATIVE_CURRENT`（本目录索引与冲突规则）  
> 当前工作树应用清单版本：`0.2.7`；最新已发布版本：`v0.2.6`；设计基线：`DESIGN v0.3.1b`  
...
自动备份和固定能力验证账本问题。其结果已经绑定 `v0.2.6` 不可移动标签和制品；不要把它与当前
`v0.2.7` 工作树证据合并。历史增量事实见
