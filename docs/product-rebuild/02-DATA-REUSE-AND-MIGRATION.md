...
- 两项已随 `v0.2.9` 来源提交 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47` 冻结。0.2.10 与当前 0.2.11 均没有新增迁移，前向上限仍为 Data `0077` / Tauri `80`。
...
> 规则：只向前追加；应用清单为 `0.2.11` 未签名人工复测候选，尚未打标签或发布；现有 `v0.2.10` 及更早版本的迁移、安装包和来源证据保持不可变。
