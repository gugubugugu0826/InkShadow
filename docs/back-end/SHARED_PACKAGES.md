...
> 当前发布目标：`0.2.16`；候选提交、安装包、标签和 Release 结果以最终发布证据为准；设计基线：`DESIGN v0.3.1b`  
...
- 当前源码沿用 Data `0082_author_recovery_records.sql`／Tauri `85`，本轮没有新增迁移。v0.2.15 及更早迁移、标签、Release 和附件保持不可变。
- 当前结论来自源码和自动化；真实供应商调用、真实安装程序和现场数据库均未执行或未取得。
