...
> 基于源码复核：2026-08-23  
> 桌面端应用清单版本：`0.2.9`；最新公开版本：[`v0.2.7`](https://github.com/gugubugugu0826/InkShadow/releases/tag/v0.2.7)（未签名工程预发行）；候选与标签解析提交均为 `cb97876894d6f02c4c901745c95533da7b0260fe`  
...
当前应用清单为 0.2.9；最新公开安装包仍为 v0.2.7 未签名工程预发行。
