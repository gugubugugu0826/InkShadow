...
> 基于源码复核：2026-08-23  
> 桌面端应用清单版本：`0.2.10`（未签名人工复测候选；未打标签、未发布）；最新公开版本：[`v0.2.9`](https://github.com/gugubugugu0826/InkShadow/releases/tag/v0.2.9)（未签名工程预发行），发布来源提交 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47`  
...
`v0.2.9` 继续向前追加 Data `0076`–`0077` / Tauri `79`–`80`，并已从来源提交 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47` 公开为未签名工程预发行。0.2.10 当前未新增数据库迁移，仍只作为人工复测候选。
当前差异与边界见
...
当前应用清单为 0.2.10 未签名人工复测候选；最新公开安装包为 v0.2.9 未签名工程预发行。
