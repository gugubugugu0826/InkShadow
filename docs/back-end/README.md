...
> 基于源码复核：2026-09-02  
> 当前交付目标：`0.2.17` 人工复测候选；当前源码迁移上限为 Data `0082`／Tauri `85`，本轮没有新增迁移；真实安装人工复测前不授权标签或 GitHub Release  
...
当前交付目标为 0.2.17 人工复测候选；候选提交、安装包和人工复测状态只能由本轮最终证据确认。已发布的 v0.2.16 及更早标签、Release、附件、安装包和来源证据保持不变。本轮没有远端发布授权。
