...
> 2026-08-22 当前工作树增量：直接模式已收敛为创作首页、作品库以及项目内正文、规划、设定、检查；设置、外观和专业模式切换进入右上角菜单。普通页面隐藏路由、追踪和内部存储等技术细节，但所有生成结果仍以可阅读的隔离结果呈现，每次远程发送逐次披露，作者明确“使用这版”后才写正文；专业模式继续显示完整控制。一次点击远程授权和自动正文仍待独立授权。全量界面、浅深色、键盘、目标宽度和系统百分之二百缩放尚未完成本轮验证。
