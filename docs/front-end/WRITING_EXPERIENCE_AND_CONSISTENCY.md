...
以上为 0.2.10 候选合同和当前修复范围。聚焦回归、全量门禁、真实安装和真人视觉复核尚待本轮证据；本节不构成发布结论。
...
> 源码复核：2026-08-23  
> 应用清单版本：`0.2.10`（未签名人工复测候选；未打标签、未发布）；最新公开版本：[`v0.2.9`](https://github.com/gugubugugu0826/InkShadow/releases/tag/v0.2.9)（未签名工程预发行），发布来源提交 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47`  
