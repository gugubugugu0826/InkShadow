...
> 工程状态：`v0.2.7` 当前工作树最终 `pnpm release:check` 已通过；尚未形成干净发布候选，下方 `v0.2.6` 结果全部是不可继承的历史发布证据  
...
| 范围             | 当前结论                                                                               | 证据边界                                                                               |
| ---------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| 版本             | 工作树清单已升至 `0.2.7`                                                               | 尚无干净候选提交、标签、安装程序或公开发布                                             |
...
| 普通界面         | 直接模式只保留创作首页、作品库和项目内正文、规划、设定、检查；专业术语大幅中文化并隐藏 | 浅色、深色、四个目标宽度、键盘、焦点和系统百分之二百缩放尚未完成本轮矩阵               |
...
- 以上数字只绑定当前工作树。干净发布候选、安装程序、浏览器端到端、真实外部模型，以及真机宽度、浅色／深色主题和百分之二百缩放仍待验证。
