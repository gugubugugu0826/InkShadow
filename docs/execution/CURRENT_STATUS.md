...
> 更新日期：2026-08-28  
> 当前版本：`0.2.14`；两次同源候选均已在远端门禁准确失败并停止发布，标签和 Release 尚未创建；第二次测试稳定化修复正在形成新的唯一候选  
> 发布保护：0.2.13 五项本地候选附件、已发布的 `v0.2.12` 及更早标签、Release、安装包和来源证据保持不可变  
> 历史边界：`v0.2.4` 仍绑定基线提交 `b74d36ef3342db6813d1d43771bc82c0ed2aa1fb`；`v0.2.3` 隐式云调用安全公告继续保留

## 2026-08-28 0.2.14 未签名预发行
