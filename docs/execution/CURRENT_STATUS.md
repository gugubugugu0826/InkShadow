...
> 更新日期：2026-08-24  
> 当前工作树应用清单版本：`0.2.10`，状态为未签名人工复测候选；尚未打标签或发布；`v0.2.8` 人工复测包继续保留在本地  
> 最新公开工程预发行：`v0.2.9`，来源提交 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47`；既有标签、Release 和附件保持不可变  
> 历史边界：`v0.2.4` 仍绑定基线提交 `b74d36ef3342db6813d1d43771bc82c0ed2aa1fb`；`v0.2.3` 隐式云调用安全公告继续保留

## 2026-08-24 0.2.10 两轮真实安装复测修复候选
