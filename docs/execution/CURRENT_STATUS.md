...
> 更新日期：2026-08-23  
> 当前工作树应用清单版本：`0.2.7`；最新公开版本为未签名工程预发布 `v0.2.7`  
> 工程状态：`v0.2.7` 已从最终干净提交完成本机候选、远端持续集成、带说明标签、公开预发布和三个附件回下载复核；`95904b…` 与 `ddd121b…` 的失败候选继续保留为历史，下方 `v0.2.6` 及更早结果均为不可继承的历史发布证据  
