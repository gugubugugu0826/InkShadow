...
> 更新日期：2026-08-22  
> 当前应用清单版本：`0.2.6`；最新公开版本为未签名工程预发布 `v0.2.6`  
> 工程状态：D1–D5 聚焦真机结果绑定 `722e67e` 的隔离 Windows Tauri 程序；最终干净候选、标签解析、发布清单和公开附件绑定 `b744d042eeafdd9db586388d71e701b1d937f366`  
> 历史边界：`v0.2.4` 仍绑定基线提交 `b74d36ef3342db6813d1d43771bc82c0ed2aa1fb`；`v0.2.3` 隐式云调用安全公告继续保留  
> 远端边界：发布时远端 `main` 与标签解析均为 `b744d042eeafdd9db586388d71e701b1d937f366`；发布后的文档提交可以使 `main` 前进，但 `v0.2.6` 标签和发布清单不得移动
