...
0.2.8 未签名人工复测安装包已生成但尚未启动；构建与校验记录见 [`2026-08-24-V028-MANUAL-RETEST-INSTALLER.md`](2026-08-24-V028-MANUAL-RETEST-INSTALLER.md)。
...
- 修复分支：`codex/v0.2.7-round2-fixes`；修复验证时应用版本为 0.2.7，随后本地人工复测清单前移至 0.2.8。
