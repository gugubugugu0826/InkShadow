...
> 更新日期：2026-08-20  
> 证据范围：当前应用清单版本与最新公开标签均为 `v0.2.5`；唯一来源提交为 `5b3e212cafde10cd75fa87b7b74bfdfff9347a3d`。本节记录该 clean-HEAD 候选、main CI、tag、制品与公开回下载事实；下方旧版本结果按原日期保留为历史快照。真实 Provider、Windows Tauri 人工流程、系统 200% DPI 与外部应用打开均为 `BLOCKED_EXTERNAL`。
