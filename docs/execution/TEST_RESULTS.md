...
> 证据范围：当前清单为 `0.2.10` 未签名人工复测候选；最新公开版本为 `v0.2.9`，发布来源提交为 `54d9647031bb97b4fc9f021d3b1acca7f6d25c47`。本轮尚未完成的命令不得继承下方历史通过数；`v0.2.8` 人工复测包和既有发布附件保持不可变。

## 2026-08-24 0.2.10 当前运行记录
