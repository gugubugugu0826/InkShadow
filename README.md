...
当前源码与本次预发布补丁版本为 `0.2.3`。代码已完成新手三入口、导入试改、四区写作工作台、Model Hub、
...
[当前状态](docs/execution/CURRENT_STATUS.md) 与 [v0.2.3 中文发布说明](docs/execution/RELEASE_CHECKLIST.md#v023-pre-release-中文说明待发布)。
...
`v0.2.3` 是本次未签名工程预览；若 Release 页面尚未显示该版本，说明发布门禁仍在执行，请勿从其他来源下载安装包。
`v0.2.0`、`v0.2.1` 和 `v0.2.2` 均为不可覆盖、不可移动标签的历史预览。
